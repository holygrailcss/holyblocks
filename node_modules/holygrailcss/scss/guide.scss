...
.guide {
    .holy-bg {
        background-image: url(../../assets/images/holygrail_big.png);
    ...
    .btn-guide {
        ...
        min-width: 40%;
        border-radius: 50px;
        background-color: $ternary-guide;
        border: 1px solid $ternary-guide !important;
